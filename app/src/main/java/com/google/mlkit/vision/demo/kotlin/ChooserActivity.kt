...
class ChooserActivity :
  ...
  override fun onItemClick(parent: AdapterView<*>?, view: View, position: Int, id: Long) {
    if( position != 2) { // IVN disable all but CameraXLivePreviewActivity!
      Toast.makeText(applicationContext, "Sorry, only CameraXLivePreviewActivity is enabled!", Toast.LENGTH_SHORT).show()
      return
    }
